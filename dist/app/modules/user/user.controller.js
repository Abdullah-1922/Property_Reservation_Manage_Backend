...
const createUser = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield user_service_1.UserService.createUserToDB(value);
...
const updateProfile = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const value = Object.assign({ image }, req.body);
    console.log(value);
    const result = yield user_service_1.UserService.updateProfileToDB(user, value);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
